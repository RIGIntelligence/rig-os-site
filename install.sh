...
REPO_NAME='rig-os-site'
REPO_SLUG='rig-os-site'
DEFAULT_BRANCH='main'
GITHUB_URL='https://github.com/rodgemd1-lgtm/rig-os-site'
GITHUB_RAW_BASE='https://github.com/rodgemd1-lgtm/rig-os-site/raw/main'
QNAP_CLONE='ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/rig-os-site.git'
