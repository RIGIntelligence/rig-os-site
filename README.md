...
Public RIG OS static website and case-study pages. Evidence from the tracked tree: no framework signal detected from tree scan.

## Live State

| Field | Value |
| --- | --- |
| GitHub | https://github.com/rodgemd1-lgtm/rig-os-site |
| QNAP canonical/mirror | `ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/rig-os-site.git` |
| Lane | `public-web` - public identity and web surfaces |
| Visibility | `public` |
| Primary language | `HTML` |
| Last pushed | `2026-05-06T03:39:44Z` |
| QNAP status | `imported_to_qnap_gitea` |
| QNAP HEAD | `5acad49809ab` |
| Consolidation action | `keep-separate-public` |
| Canonical target | `rig-os-site` |
...
- Repo deep dive: [rig-os-site](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-deep-dives/rig-os-site.md)
...
0 data/config/knowledge-like files; 0 docs/notes; 1 media/design assets; 0 sensitive-path-name matches.
...
28 tracked files across 1 directories. Code files: 26. Test files: 0. 0 data/config/knowledge-like files; 0 docs/notes; 1 media/design assets; 0 sensitive-path-name matches.

Aggregate GitHub tree size: `1.1 MB` across `28` blobs.
...
Full public inventory: [rig-os-site.txt](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-file-inventories/rig-os-site.txt)
...
```bash
git clone ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/rig-os-site.git
cd rig-os-site
...
- Blueprint source: `https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-readme-blueprints/rig-os-site.md`
- Applied target: `rig-os-site`
...
```bash
curl -fsSL https://github.com/rodgemd1-lgtm/rig-os-site/raw/main/install.sh | bash
```

Install and clone the source-of-truth repo:

```bash
curl -fsSL https://github.com/rodgemd1-lgtm/rig-os-site/raw/main/install.sh | RIG_CLI_CLONE=1 bash
```
...
```bash
rig-os-site info
rig-os-site capabilities
rig-os-site services
rig-os-site clone
rig-os-site doctor
```
...
```bash
git clone ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/rig-os-site.git
git clone https://github.com/rodgemd1-lgtm/rig-os-site.git
```
